...
class table_acceleration_window(wx.Frame):
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, -1, "Camera Delay", style=wx.DEFAULT_FRAME_STYLE & ~wx.MAXIMIZE_BOX ^ wx.RESIZE_BORDER, size=(240, 240))
        self.parent = parent
        self.window_sizer = wx.BoxSizer(wx.HORIZONTAL)
...
class shoot_at_window(wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, -1, "Shoot  at", style=wx.DEFAULT_FRAME_STYLE & ~wx.MAXIMIZE_BOX ^ wx.RESIZE_BORDER, size=(530, 100))
        self.parent = parent
        self.window_sizer = wx.BoxSizer(wx.HORIZONTAL)
